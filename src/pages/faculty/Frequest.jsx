...
const FRequest = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        setStats({
          total: response.data. total_request, // Use correct keys
          resolved: response.data.resolved_request,
        });
      })
    ...
    <div className={`flex h-screen ${darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"}`}>
      ...
      <main className="flex-1 p-6 overflow-y-auto scrollbar-hide">
        ...
        <div className="grid grid-cols-2 gap-6 mt-6">
          ...
          >
            <h3 className="text-lg uppercase">Total Requests</h3>
          ...
          >
            <h3 className="text-lg uppercase">Requests Resolved</h3>
            <p className="text-3xl font-bold">
