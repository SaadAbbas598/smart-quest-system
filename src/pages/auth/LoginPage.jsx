...
//   return (
//     <div
//       className={`flex h-screen transition-all ${darkMode ? "bg-gray-900 text-white" : "bg-gradient-to-r from-blue-50 to-purple-50"}`}
//     >
//       <ToastContainer />
//       <div className="w-1/2 flex justify-center items-center">
//         <div
//           className={`w-full max-w-md p-8 rounded-xl shadow-2xl transition-all ${darkMode ? "bg-gray-800 text-white" : "bg-white"}`}
//         >
//           {error && <p className="text-red-600 text-center mb-4">{error}</p>}
//           <h2 className="text-4xl font-bold text-center mb-6">Welcome Back!</h2>
//           <p className="text-center mb-8">Sign in to your account to continue</p>
